...
namespace UnityEditor.Experimental.FrameRecorder.Input
{
    ...
    public class AnimationInputSettingsEditor : InputEditor
    {
        public override void OnInspectorGUI()
        {
            ...
            animImputSetting.gameObject = EditorGUILayout.ObjectField("Game Object", animImputSetting.gameObject, typeof(UnityEngine.GameObject), true) as UnityEngine.GameObject;
